...
var tt_tags = new Array('a','b','center','div','em','h1','h2','h3','i','img','li','ol','pre','span','sub','sup','table','td','th','tr','tt','u','ul');
/////////////////////////////////////////////////////////////////////
...
function tt_Htm(tt, t_id, txt)
{
	...
	t_y += '<tr><td><table class="tooltip" width="100%">';
	t_y += '<tr class="tooltip"><td ' + (t_br? 'nowrap ' : '') + 'class="tooltip">';
	t_y += txt;
